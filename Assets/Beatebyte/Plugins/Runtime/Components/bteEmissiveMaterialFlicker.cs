...
namespace BeatebyteToolsEditor.Components
{
    ...
    /// <summary>
    /// The Bte Flicker FX for Emissive Material.
    /// </summary>
    [AddComponentMenu("Beatebyte/Emissive Material Flicker FX")]
    [eClassHeader("  Emissive Material Flicker FX", iconName = "icon_v2")]
    public class bteEmissiveMaterialFlicker : eMonoBehaviour
    { 
