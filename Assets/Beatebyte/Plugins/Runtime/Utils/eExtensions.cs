...
{    
    ...
    public static class eExtensions
    {
        ...
        public static List<T> eCopy<T>(this List<T> list)
        {
        ...
        public static List<T> eToList<T>(this T[] array)
        {
        ...
        public static T[] eToArray<T>(this List<T> list)
        {
